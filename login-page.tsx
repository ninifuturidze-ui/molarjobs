      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          >
            {loading ? (
              <>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5" style={{ animation: 'spin 0.8s linear infinite', marginRight: 8 }}>
              ...
              <span style={{ display: 'flex', alignItems: 'center' }}>
                ...
                <span style={{ marginLeft: 24, display: 'flex', alignItems: 'center' }}>
