...
const STEPS = ['Job Details', 'Clinic Info', 'Preview']
        ...
        {submitted ? (
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
              <button
                onClick={() => { setSubmitted(false); setStep(0); setForm({ title: '', jobType: 'full-time', salaryMin: '', salaryMax: '', salaryType: 'monthly', description: '', specialties: [], experience: '', clinicName: '', city: '', district: '', address: '', phone: '', email: '', website: '', logo: null, logoPreview: '' }) }}
                style={{
